...
public class DriveAssignmentService {
    ...
    public void createDrivingTable() {
        ...
        List<DrivingEntity> drivingEntities = new ArrayList<>();
        for (int i = 0; i < driverNumber; i++) {
            ...
            for (int j = 0; j < busLineNumber; j++) {
                ...
                drivingEntities.add(new DrivingEntity(driver, busLine, turnNumber));
            }
        ...
        MainRun.drivingDAO.addNewDriving(drivingEntities);
    }
